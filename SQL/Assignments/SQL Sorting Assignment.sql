...
-- Sql Questions to be answered

-- 1 Select employees who work in the HR Department

SELECT department
FROM employees
WHERE department = "HR";

-- 2 Select employees aged between 20 and 35 years
...
-- 3 Select employees from Chicago who work on full-time basis

SELECT  location, employment_status
FROM employees
WHERE location= "Chicago" and employment_status = "Full-time";

-- 4 Select employees from Marketing, Sales and Finance departments
